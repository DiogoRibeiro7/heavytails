...
| [10.5281/zenodo.22062643](https://doi.org/10.5281/zenodo.22062643) | **Version 0.4.0 only** | A result depends on the version you ran, which for numerical work it usually does |
...
Citing release 0.4.0 exactly:

```bibtex
@software{ribeiro_heavytails_0_4_0,
  author    = {Ribeiro, Diogo},
  title     = {heavytails: A Python Library for Heavy-Tailed
               Probability Distributions},
  year      = {2026},
  ...
  url       = {https://doi.org/10.5281/zenodo.22062643}
}
```
...
> <https://doi.org/10.5281/zenodo.22062643>

### IEEE

> D. Ribeiro, "heavytails: A Python Library for Heavy-Tailed Probability
> Distributions," version 0.4.0, Zenodo, 2026. doi: 10.5281/zenodo.22062643.

### MLA

> Ribeiro, Diogo. *heavytails: A Python Library for Heavy-Tailed
> Probability Distributions*. Version 0.4.0, Zenodo, 2026,
> doi:10.5281/zenodo.22062643.

### Chicago

> Ribeiro, Diogo. 2026. "heavytails: A Python Library for Heavy-Tailed
> Probability Distributions." Version 0.4.0. Zenodo.
> <https://doi.org/10.5281/zenodo.22062643>.
